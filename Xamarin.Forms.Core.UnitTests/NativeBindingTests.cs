...
namespace Xamarin.Forms.Core.UnitTests
{
	...
	public static class MockNativeViewExtensions
	{
		...
		public static void SetBinding(this MockNativeView target, string targetProperty, BindingBase binding, string updateSourceEventName = null, object defaultValue = null)
		{
			NativeBindingHelpers.SetBinding(target, targetProperty, binding, updateSourceEventName, defaultValue);
		}

		internal static void SetBinding(this MockNativeView target, string targetProperty, BindingBase binding, INotifyPropertyChanged propertyChanged, object defaultValue = null)
		{
	...
	public class NativeBindingTests
	{
		...
		public void DoNotApplyNull()
		{
			...
			native.SetBinding("CantBeNull", new Binding("FFoo", BindingMode.TwoWay), defaultValue:"");
			Assert.NotNull(native.CantBeNull);
