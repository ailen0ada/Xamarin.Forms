...
namespace Xamarin.Forms
{
	...
	{
		public static void SetBinding<TNativeView>(TNativeView target, string targetProperty, BindingBase bindingBase, string updateSourceEventName=null, object defaultValue = null) where TNativeView : class
		{
			...
			SetBinding(target, targetProperty, bindingBase, eventWrapper, defaultValue);
		}

		internal static void SetBinding<TNativeView>(TNativeView target, string targetProperty, BindingBase bindingBase, INotifyPropertyChanged propertyChanged, object defaultValue = null) where TNativeView : class
		{
			if (target == null)
